      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <header className="text-center mb-8 animate-slide-up relative">
          <a
            ...
            className="absolute top-0 right-0 flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white px-3 py-2 rounded-full shadow-lg shadow-[#5865F2]/30 transition-all duration-200 hover:scale-105"
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-bold">Discord Kanto Reforged</span>
          </a>
